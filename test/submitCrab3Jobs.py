...
#config.JobType.pyCfgParams = ['globalTag=MCRUN2_74_V9A', 'isMC=True', 'runMVAPUPPETAnalysis=True', 'applyJECtoPuppiJets=False', 'applyZSelections=True', 'dropAnalyzerDumpEDM=False']
config.JobType.pyCfgParams = ['globalTag=MCRUN2_74_V9', 'isMC=True', 'runMVAPUPPETAnalysis=True', 'applyJECtoPuppiJets=False', 'applyZSelections=True', 'dropAnalyzerDumpEDM=False']
#config.JobType.pyCfgParams = ['globalTag=MCRUN2_74_V8', 'isMC=True', 'runMVAPUPPETAnalysis=True', 'applyJECtoPuppiJets=False', 'applyZSelections=True', 'dropAnalyzerDumpEDM=False']
