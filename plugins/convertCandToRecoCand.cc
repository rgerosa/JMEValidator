////////////////////////////////////////////////////////////////////////////////
//
// convertCandToRecoCand
// ---------------------------
//
//                          01/08/2015 Alexx Perloff <aperloff@physics.tamu.edu>
//                                     Originally Alexx made convertPackedCandToRecoCand.
//                              ----> Satoshi Hasegawa<satoshi@fnal.gov> modified so that it handle not PackedCandiadte but Candidate.
////////////////////////////////////////////////////////////////////////////////
...
class convertCandToRecoCand : public edm::EDProducer
{
public:
  // construction/destruction
  convertCandToRecoCand(const edm::ParameterSet& iConfig);
  ~convertCandToRecoCand() {;}
...
//______________________________________________________________________________
convertCandToRecoCand::convertCandToRecoCand(const edm::ParameterSet& iConfig)
...
//______________________________________________________________________________
void convertCandToRecoCand::produce(edm::Event& iEvent,const edm::EventSetup& iSetup)
{
...
//______________________________________________________________________________
void convertCandToRecoCand::endJob()
{
}
...
DEFINE_FWK_MODULE(convertCandToRecoCand);
