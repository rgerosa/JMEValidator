...
class JetMETAnalyzer : public JME::Analyzer
{
public:
...
private:
  ...
  std::vector<float>& jte = tree["jte"].write<std::vector<float>>();
  std::vector<float>& jtpt = tree["jtpt"].write<std::vector<float>>();
  std::vector<float>& jteta = tree["jteta"].write<std::vector<float>>();
  std::vector<float>& jtphi = tree["jtphi"].write<std::vector<float>>();
  std::vector<float>& jtm = tree["jtm"].write<std::vector<float>>();
  std::vector<float>& jty = tree["jty"].write<std::vector<float>>();
