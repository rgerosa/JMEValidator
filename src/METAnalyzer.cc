...
//  else throw cms::Exception("Configuration")<<"[METAnalyzer] input gen jet cleaned collection not given \n";
  ...
  else throw cms::Exception("Configuration")<<"[METAnalyzer] missing met filter bits  \n";

  if (iConfig.existsAs<edm::InputTag >("srcTriggerBits"))
    srcTriggerBits_ = iConfig.getParameter<edm::InputTag >("srcTriggerBits");
  else throw cms::Exception("Configuration")<<"[METAnalyzer] missing trigger bits  \n";
  ...
  else throw cms::Exception("Configuration")<<"[METAnalyzer] missing trigger prescales  \n";
