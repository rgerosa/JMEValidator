#define validatorNtuple_cxx
#include "JMEAnalysis/JMEValidator/interface/validator_Ntuple.h"
#include <TH2.h>
#include <TStyle.h>
#include <TCanvas.h>

void validatorNtuple::Loop()
{
//   In a ROOT session, you can do:
//      Root > .L validatorNtuple.C
//      Root > validatorNtuple t
...
//______________________________________________________________________________
double validatorNtuple::sumEOOT() {
   int iIT = itIndex();
...
//______________________________________________________________________________
double validatorNtuple::sumLOOT() {
   int iIT = itIndex();
   if(iIT>(int)(*npus).size()-1) return 0;
   double sum = 0;
